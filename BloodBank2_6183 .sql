...
USE master
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'BloodBank2')
	DROP DATABASE [BloodBank2]
GO
...
EXEC Pracownik_wstaw 1,'Gabriel','Nowak','12343290812','Wroclaw','ul.Nudna 11',3,'Stale',2,'Doktor',NULL,NULL,1
EXEC Pracownik_wstaw 2,'Michal','Kowal','00234567122','Wroclaw','ul.Piekna 44',2,'Tymczasowe',2,'Asystent',NULL,NULL,1
EXEC Pracownik_wstaw 3,'Amadeusz','Blaszczyk','56423542189','Warszawa','ul.Kreta 2',2,'Stale',2,'Asystent',NULL,NULL,2
EXEC Pracownik_wstaw 4,'Wojtek','Nazwisko','031442113282','Warszawa','ul.Ruska 1',1,'Tymczasowe',1,'Doktor',NULL,NULL,3
GO
...
EXEC Bank_wstaw 'A',900
EXEC Bank_wstaw 'B',150
EXEC Bank_wstaw 'A+',250
EXEC Bank_wstaw '0',135
EXEC Bank_wstaw 'AB',530
GO
...
VALUES ('TEST','A','2018-12-22',1,1,25,NULL);

UPDATE Bank SET Ilosc = Ilosc - 25
WHERE GrKrwi = 'A';
...
EXEC master.dbo.sp_addlinkedserver   
    @server = N'DESKTOP-4AFUV69\SQLSERVER',   
    @srvproduct=N'SQL Server' ;  
GO  
EXEC master.dbo.sp_addlinkedsrvlogin   
    @rmtsrvname = N'DESKTOP-4AFUV69\SQLSERVER',   
    @locallogin = NULL ,   
    @useself = N'True' ;  
GO